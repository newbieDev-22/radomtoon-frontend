  ...
  return (
    <div className="flex justify-center flex-col">
      <div className="flex flex-row justify-center w-full border-b-1 shadow-md pb-4">
        <button className="px-6 py-2 m-2 hover:rounded-md hover:underline focus:underline focus:rounded-md hover:bg-gray-300 focus:outline-none focus:bg-gray-300 ">
          About
        </button>
        <button className="px-6 py-2 m-2 hover:rounded-md hover:underline focus:underline focus:rounded-md hover:bg-gray-300 focus:outline-none focus:bg-gray-300">
          Created
            ...
            <div>
              {isEditing ? (
                <textarea
                  ...
                  className="w-96 border border-solid-2 rounded-md p-1"
                />
              ) : (
