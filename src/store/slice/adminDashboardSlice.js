...
export const adminDashboardSlice = (set) => ({
  ...
  fetchDashboardData : async () => {
    ...
    Object.keys(geoJsonPostResponse.data.provinceCount).forEach(key => {
      ...
      if (provinceName) { mappedIncomingData[provinceName] = geoJsonPostResponse.data.provinceCount[key] }
    })
    ...
    set(state => ({
      dashboardData: {
        ...
        textBlockData: [ activeCreator.data, activeSupporter.data, averageFunds.data, successProjects.data ],
