...
export default function TierSummaryCard({
  title = "Test tier project 1",
  price = "20",
  date = "Mon, July 22 2024 10:59 AM UTC +07:00",
}) {
  return (
    <div className="card bg-base-100 w-96  border-2 p-5 border-slate-900 rounded-lg ">
      ...
      <div className="card-body items-center text-center px-2">
        ...
        <p className="text-left">{dayjs(date).format("YYYY-MM-DD HH:MM:ss")}</p>
      </div>
    </div>
  );
}
